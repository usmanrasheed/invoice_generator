...
class SelectInvoiceTemplate extends StatelessWidget {
  const SelectInvoiceTemplate({super.key});
          ...
          Row(
            children: [
              ...
              _templateOption(
                ...
                imagePath: 'assets/images/template1.jpg',
                onTap: () {
                  Utils.toastMessage('Invoice template 2');
          ...
          Row(
            children: [
              _templateOption(
                ...
                imagePath: 'assets/images/template1.jpg',
                onTap: () {
                  Utils.toastMessage('Invoice template 3');
                  //Navigator.pop(context); // Close popup
                  // TODO: Use Template 1
                },
              ),
              ...
              _templateOption(
                ...
                imagePath: 'assets/images/template1.jpg',
                onTap: () {
                  Utils.toastMessage('Invoice template 4');
                  //Navigator.pop(context); // Close popup
                  // TODO: Use Template 2
                },
              ),
